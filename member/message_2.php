...
<tr>
	...
	<tr>
		<td>
		<img src="../img/message_title.gif" width="30" height="30" align="absmiddle" hspace="2">보낸쪽지함
		</td>
	</tr>
	</table>
	</td>
...
<tr bgcolor="#CCCCCC">
	...
	<td align="center" width="30" class="line2">확인시간</td>
</tr>
<?
	$a_re_chk['Y'] = "확인";
...
for($i=0; $rows3=mysql_fetch_array($result3); $i++) {
	...
	<input type="checkbox" name="mnum[]" value=<?=$rows3[mnum]?>>
		...
		<td align="center" class="line">
		<a href="message_view.php?mnum=<?=$rows3[mnum]?>&gb=2">
			<?=$msg_char?>
			</a>
		</td>
		<td align="center" class="line">
